...
declare const json: (data: any, params?: any) => string, isJsonEncodedObject: (object: any) => boolean, binaryConcat: (...args: any[]) => any, binaryConcatArray: (arr: any) => any, urlencodeBase64: (base64string: any) => any, base58ToBuffer: (s: string) => Buffer, bufferToBase58: (buf: Buffer) => string
/**
