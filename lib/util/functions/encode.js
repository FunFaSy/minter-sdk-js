...
// };
const json = (data) => JSON.stringify(data), isJsonEncodedObject = object => ((typeof object === 'string') &&
    (object.length >= 2) &&
    ((object[0] === '{') || (object[0] === '[')))
...
/**
   ...
   */
, toBuffer = (v) => {
    if (typeof v === 'string' && prefix_1.isMinterPrefixed(v)) {
        return mToBuffer(v);
    }
    return external_1.ethToBuffer(v);
}
/**
