...
const safeFloat=          (o, k,          $default, n =   asFloat (prop (o, k))) => (isNumber (n)          ? n                         : $default)
    ...
    , safeIntegerProduct= (o, k, $factor, $default, n = asInteger (prop (o, k))) => (isNumber (n)          ? parseInt (String(n * $factor))    : $default)
    , safeTimestamp=      (o, k,          $default, n =   asFloat (prop (o, k))) => (isNumber (n)          ? parseInt (String(n * 1000))       : $default)
    ...
    , safeIntegerProduct2= (o, k1, k2, $factor, $default, n = asInteger (prop2 (o, k1, k2))) => (isNumber (n)          ? parseInt (String(n * $factor))    : $default)
    , safeTimestamp2=      (o, k1, k2,          $default, n =   asFloat (prop2 (o, k1, k2))) => (isNumber (n)          ? parseInt (String(n * 1000))       : $default)
