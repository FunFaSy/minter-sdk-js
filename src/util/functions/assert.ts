...
const assertIsNumber = (input: any, msg: string = undefined) => assert(isNumber(input),msg || `Only supports number but input was: ${input}`);
const assertIsInt = (input: any, msg: string = undefined) => assert(isInteger(input),msg || `Only supports integer number but input was: ${input}`);
const assertIsPositiveInt = (input: any, msg: string = undefined) => assert(isInteger(input) && 0 <= input ,msg || `Only supports positive integer number but input was: ${input}`);
